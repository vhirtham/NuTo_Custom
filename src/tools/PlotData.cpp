...
NuTo::PlotData::PlotData(std::string title, std::array<unsigned char, 3> lineColor, eLineType lineType)
    : mLineType(lineType)
    , mTitle(title)
...
std::string NuTo::PlotData::GetSetupString() const
{
...
std::string NuTo::PlotData::GetColorCodeString() const
{
