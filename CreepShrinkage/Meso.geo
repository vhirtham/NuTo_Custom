...
Point(6)  = {    CX,   CY+RC,   0.0,   SI};
Point(7)  = {    CX,   CY-RC,   0.0,   SI};
Point(8)  = {  CX+L,    CY-L,   0.0,   SI};
Point(9)  = {  CX+L,CY-L+RLR,   0.0,   SI};
Point(10) = {  CX+L,CY-L-RLR,   0.0,   SI};
Point(11) = {  CX-L,    CY+L,   0.0,   SI};
Point(12) = {  CX-L,CY+L+RUL,   0.0,   SI};
Point(13) = {  CX-L,CY+L-RUL,   0.0,   SI};
Point(14) = {  CX+L,    CY+L,   0.0,   SI};
Point(15) = {  CX+L,CY+L+RUR,   0.0,   SI};
Point(16) = {  CX+L,CY+L-RUR,   0.0,   SI};
Point(17) = {  CX-L,    CY-L,   0.0,   SI};
Point(18) = {  CX-L,CY-L+RLL,   0.0,   SI};
Point(19) = {  CX-L,CY-L-RLL,   0.0,   SI};
