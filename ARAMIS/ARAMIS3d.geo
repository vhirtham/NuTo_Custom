...
Plane Surface(206) = {71};
Plane Surface(207) = {72};
Plane Surface(208) = {73};
Ruled Surface(209) = {74};
Ruled Surface(210) = {75};

// Right lower cylinder
Plane Surface(211) = {76};
Plane Surface(212) = {77};
Plane Surface(213) = {78};
Plane Surface(214) = {79};
Plane Surface(215) = {80};
Ruled Surface(216) = {81};
Ruled Surface(217) = {82};

// Left upper cylinder
Plane Surface(218) = {83};
Plane Surface(219) = {84};
Plane Surface(220) = {85};
Plane Surface(221) = {86};
Plane Surface(222) = {87};
Ruled Surface(223) = {88};
Ruled Surface(224) = {89};

// Right upper cylinder
Plane Surface(225) = {90};
Plane Surface(226) = {91};
Plane Surface(227) = {92};
Plane Surface(228) = {93};
Plane Surface(229) = {94};
Ruled Surface(230) = {95};
Ruled Surface(231) = {96};

// Left lower cylinder
Plane Surface(232) = {97};
Plane Surface(233) = {98};
Plane Surface(234) = {99};
Plane Surface(235) = {100};
Plane Surface(236) = {101};
Ruled Surface(237) = {102};
Ruled Surface(238) = {103};

// Front and Back
Plane Surface(239) = {63,104,106,108,110,112};
Plane Surface(240) = {64,105,107,109,111,113};


// Volumes ---------------------------------------------------------------

Surface Loop(300) = {200,201,202,203,239,240,209,210,216,217,223,224,230,231,237,238};
Volume(301) = {300};

Surface Loop(302) = {204,205,206,207,209,210};
Surface Loop(303) = {211,212,213,214,216,217};
Surface Loop(304) = {218,219,220,221,223,224};
Surface Loop(305) = {225,226,227,228,230,231};
Surface Loop(306) = {232,233,234,235,237,238};
...
Physical Volume(313) = {307, 308, 309, 310, 311};
